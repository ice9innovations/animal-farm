...
#   - Uses face_venv (not venv) to match face.sh
...
#   - Copies pre-configured services/face-api.service instead of generating one
#
# Usage:
...
VENV="$SCRIPT_DIR/face_venv"
SERVICE_SRC="$SCRIPT_DIR/services/face-api.service"
