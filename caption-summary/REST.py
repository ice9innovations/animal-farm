...
SYNTHESIS_PROMPT_INSTRUCTION = (
    ...
    "is explicit in the preferred caption and central to the image. If the preferred "
    "caption is NSFW and explicit adult anatomy or sexual contact is central, preserve "
    "the anatomically specific fact in concise clinical language; do not euphemize "
    "visible genitals, vulva, labia, vagina, penis, anus, buttocks, breasts, or nipples "
    "as a lower abdomen, body part, intimate area, or vague clothing state. Keep it "
    "short, ideally 12 to 25 words. Prefer a simple subject, action, and setting. Avoid "
