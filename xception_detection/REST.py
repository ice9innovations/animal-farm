#!/usr/bin/env python3
"""
Two-Stage Object Detection REST API Service
Provides two-stage object detection: YOLO detection + classification.
"""
...
def initialize_detector() -> bool:
    """Initialize the two-stage detector once at startup - fail fast"""
    global detector
    try:
